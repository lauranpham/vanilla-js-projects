...
form.addEventListener('submit', (e) => {
	// prevent default of form to submit to server
	e.preventDefault();
	let value = amount.value || amount.placeholder;
	// all inputs even type number still returns a string therefore must apply parseInt
